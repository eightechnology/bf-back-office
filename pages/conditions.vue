<template>
    <div>
        <div class="d-md-flex justify-content-between align-items-center">
            <h5 class="mb-0">Conditions Générales d'Utilisations</h5>

            <nav aria-label="breadcrumb" class="d-inline-block mt-2 mt-sm-0">
                <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                    <li class="breadcrumb-item text-capitalize"><NuxtLink to="/">Billetfacile</NuxtLink></li>
                    <li class="breadcrumb-item text-capitalize active" aria-current="page">Conditions</li>
                </ul>
            </nav>
        </div>
        ...
        <div class="row">
            <div class="col mt-4">
                <div class="card shadow border-0 rounded">
                    <div class="card-body">
                        <h6 class="card-title fw-bold">Introduction :</h6>
                        ...
                        <h6 class="card-title fw-bold">User Agreements :</h6>
                        ...
                        <h6 class="card-title fw-bold">Restrictions :</h6>
                        <p class="text-muted">You are specifically restricted from all of the following :</p>
                        <ul class="list-unstyled text-muted">
                            <li class="mt-2"><i class="ti ti-arrow-right me-2"></i>Digital Marketing Solutions for
                                Tomorrow</li>
                            <li class="mt-2"><i class="ti ti-arrow-right me-2"></i>Our Talented &amp; Experienced
                                Marketing Agency</li>
                            <li class="mt-2"><i class="ti ti-arrow-right me-2"></i>Create your own skin to match your
                                brand</li>
                            <li class="mt-2"><i class="ti ti-arrow-right me-2"></i>Digital Marketing Solutions for
                                Tomorrow</li>
                            <li class="mt-2"><i class="ti ti-arrow-right me-2"></i>Our Talented &amp; Experienced
                        ...
                        <h6 class="card-title fw-bold">Users Question &amp; Answer :</h6>
