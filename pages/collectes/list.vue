<template>
    <div>
        <div class="d-md-flex justify-content-between align-items-center">
            <h5 class="mb-0">Collectes non publiées (1)</h5>
                    ...
                    <table class="table table-center bg-white mb-0">
                        ...
                        <tbody>
                            ...
                            <tr v-for="(t, index) in 1" :key="index">
                                ...
                                <td class="text-center p-3">320 000 000 GNF</td>
                                <td class="text-center p-3">3 000 000 GNF</td>
        ...
        <div class="d-md-flex justify-content-between align-items-center border-top pt-4">
            <h5 class="mb-0">Liste des collectes publiées (3)</h5>
        </div>
                    ...
                    <table class="table table-center bg-white mb-0">
                        ...
                        <tbody>
                            ...
                            <tr v-for="(t, index) in 3" :key="index">
                                ...
                                <td class="text-center p-3">12/02/2024</td>
                                <td class="text-center p-3">10 000 000 GNF</td>
                                <td class="text-center p-3">3 000 000 GNF</td>
                                <td class="text-center p-3"><span class="badge text-bg-primary">Terminé</span></td>
                                <td class="text-end p-3">
                                    <router-link to="/collectes/1" class="btn btn-sm btn-primary">Ouvrir</router-link>
                                    <!-- <a href="#" class="btn btn-sm btn-soft-primary ms-2"><i class="fas fa-eye"></i></a> -->
                                </td>
                            </tr>
                            <!-- End -->
