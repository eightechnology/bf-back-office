    ...
    <div>
        ...
        <form @submit.prevent="onSaveEvent" enctype="multipart/form-data">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="card border-0 rounded shadow p-4">
                        <h5 class="mb-0">Modifier la déscription</h5>
                        <div class="mb-3">
...
const selectedEvent = computed(() => eventStore.getSelectedEvent);

const eventForm = reactive({
    title: selectedEvent.value.title,
    phone: selectedEvent.value.phone,
    type: selectedEvent.value.type,
    address: selectedEvent.value.address,
    description: selectedEvent.value.description,
    starts_at: selectedEvent.value.starts_at,
    ends_at: selectedEvent.value.ends_at,
    image: selectedEvent.value.image,
    plan: selectedEvent.value.plan,
    desc_video: selectedEvent.value.desc_video,
    exit_allowed: false,
